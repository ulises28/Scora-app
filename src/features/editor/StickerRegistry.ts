...
export const ACTIVE_STICKER_LIST: StickerDefinition[] = [
    ...
    { id: 'dm', category: 'distance', features: { distance: true, duration: true, paceSpeed: true, startTime: true, location: true }, render: Renderers.drawDMModular },
    ...
    { id: 'tiny-gps', category: 'all', supportsBlackText: true, compact: true, preferredCase: 'title', features: { distance: true, duration: true, location: true }, render: Renderers.drawTinyGPS },
    ...
    { id: 'boxed-metric', category: 'distance', supportsBlackText: true, compact: true, features: { distance: true, duration: true }, render: Renderers.drawBoxedMetric },
    ...
    { id: 'mono-split', category: 'distance', supportsBlackText: false, features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawMonoSplit },
    { id: 'essential-italic', category: 'distance', supportsBlackText: true, features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawEssentialItalic },
    ...
    { id: 'modern-pill', category: 'distance', supportsBlackText: false, preferredCase: 'title', features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawModernPill },
    ...
    { id: 'brutalist-bold', category: 'distance', supportsBlackText: false, features: { distance: true, paceSpeed: true, duration: true, heartRate: true }, render: Renderers.drawBrutalistBold },
    { id: 'data-modular', category: 'distance', supportsBlackText: false, features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawDataModular },
    { id: 'glass-slice', category: 'distance', supportsBlackText: false, features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawGlassSlice },
    { id: 'stealth-bar', category: 'distance', supportsBlackText: false, features: { distance: true, paceSpeed: true, duration: true }, render: Renderers.drawStealthBar },
