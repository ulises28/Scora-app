...
export const ACTIVE_STICKER_LIST: StickerDefinition[] = [
    ...
    { id: 'studio-precision', category: 'distance', supportsCustomColor: true, supportsBlackText: true, features: { distance: true, paceSpeed: true, duration: true, elevation: true }, seasonal: false, render: Renderers.drawStudioPrecision },
    ...
    { id: 'bold-day', category: 'distance', supportsCustomColor: true, supportsBlackText: true, preferredCase: 'uppercase', features: { distance: true, date: true }, seasonal: false, render: Renderers.drawBoldDay },
    { id: 'manifest-list', category: 'all', supportsCustomColor: true, supportsBlackText: true, features: { distance: true, duration: true, paceSpeed: true, elevation: true, calories: true, temperature: true }, seasonal: false, render: Renderers.drawManifestList },
